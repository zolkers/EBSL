...
public final class MovementExecutionContext {
    ...
    public MovementExecutionContext(Minecraft minecraft, Node waypoint, Vec3 playerPos,
    ...
    public Vec3 playerPos() { return playerPos; }
    ...
    public boolean jumpCooldownConsumed() {
        return jumpCooldownConsumed;
    }
}
