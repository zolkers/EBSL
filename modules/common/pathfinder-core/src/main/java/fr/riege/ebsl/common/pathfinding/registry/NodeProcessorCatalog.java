...
public final class NodeProcessorCatalog {
    NodeProcessorCatalog() {
    }

    public List<NodeProcessor> standardProcessors() {
        return NodeProcessorRegistry.createStandardProcessors();
    }

    public List<NodeProcessor> processors(NodeProcessorType... types) {
        return NodeProcessorRegistry.createAll(types);
    }
}
